...
:PROPERTIES:
:CUSTOM_ID: accessing-the-default-application
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: configuration-before-running
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: running-the-window-loop
:END:
#+begin_src C
