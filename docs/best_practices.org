...
:PROPERTIES:
:CUSTOM_ID: always-clear-the-background
:END:
...
:PROPERTIES:
:CUSTOM_ID: avoid-z-fighting-between-adjacent-surfaces
:END:
...
:PROPERTIES:
:CUSTOM_ID: understanding-grl_color_brightness
:END:
...
*Factor interpretation:* | Factor | Result | |--------|--------| | =1.0= | 100% white | | =0.5= | 50% toward white | | =0.0= | Original color | | =-0.2= | 80% brightness | | =-0.5= | 50% brightness | | =-1.0= | Black |
...
** General Tips
:PROPERTIES:
:CUSTOM_ID: general-tips
:END:
*** Triangle Winding Order
:PROPERTIES:
:CUSTOM_ID: triangle-winding-order
:END:
...
:PROPERTIES:
:CUSTOM_ID: prefer-built-in-primitives
:END:
...
:PROPERTIES:
:CUSTOM_ID: grlmodel-and-grlmesh-ownership
:END:
